...
- Spring AI에서는 structured output을 DTO 변환으로 끝내지 말고 Bean Validation, 재시도, fallback 응답까지 함께 설계한다. 적용 예시는 [06. Structured Output과 Bean Validation](<../15. Spring AI/06. Structured Output과 Bean Validation.md>)에서 이어진다.
- DTO 결과가 tool 실행으로 연결될 때의 side effect 방어는 [07. Tool Calling과 Side Effect 방어](<../15. Spring AI/07. Tool Calling과 Side Effect 방어.md>)를 함께 본다.
