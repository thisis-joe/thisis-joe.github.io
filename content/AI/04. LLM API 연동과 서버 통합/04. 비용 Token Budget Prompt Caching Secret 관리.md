...
- Spring AI 적용 시 비용 관리는 model profile, token budget, usage metric을 gateway에서 함께 남기는 방식으로 시작한다. 호출 경계는 [03. Spring Boot 계층 설계와 AI Gateway](<../15. Spring AI/03. Spring Boot 계층 설계와 AI Gateway.md>)를 함께 본다.
- 비용 폭증과 quota 대응은 [12. Production Readiness와 인프라 협업](<../15. Spring AI/12. Production Readiness와 인프라 협업.md>)에서 운영 계약 관점으로 이어진다.
