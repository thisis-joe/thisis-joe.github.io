...
- Spring AI 비용 폭증은 token budget, model profile, request cap, usage metric을 함께 봐야 잡힌다. 운영 지표와 알림 설계는 [11. Observability와 장애 대응 런북](<../15. Spring AI/11. Observability와 장애 대응 런북.md>)에서 이어진다.
- quota와 예산 한도를 인프라 운영 계약으로 합의하는 방법은 [12. Production Readiness와 인프라 협업](<../15. Spring AI/12. Production Readiness와 인프라 협업.md>)을 함께 본다.
