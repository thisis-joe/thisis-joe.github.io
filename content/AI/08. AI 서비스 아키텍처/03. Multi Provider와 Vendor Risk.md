...
- Spring AI에서는 provider 교체 가능성을 model profile, auto configuration, gateway 정책으로 흡수해야 한다. 설정 경계는 [04. ChatClient Model Auto Configuration](<../15. Spring AI/04. ChatClient Model Auto Configuration.md>)에서 이어진다.
- provider 장애와 비용 리스크를 운영 계약으로 다루는 방법은 [12. Production Readiness와 인프라 협업](<../15. Spring AI/12. Production Readiness와 인프라 협업.md>)을 함께 본다.
