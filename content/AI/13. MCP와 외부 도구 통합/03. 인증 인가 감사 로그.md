...
- Spring AI MCP 통합에서는 tool 호출 주체, 권한 scope, 감사 로그를 서버 경계에서 남겨야 한다. 보안·운영 경계는 [08. MCP Client Server 통합](<../15. Spring AI/08. MCP Client Server 통합.md>)에서 이어진다.
- 운영 배포 전 점검 항목은 [12. Production Readiness와 인프라 협업](<../15. Spring AI/12. Production Readiness와 인프라 협업.md>)을 함께 본다.
