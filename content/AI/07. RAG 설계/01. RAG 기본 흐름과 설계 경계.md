...
- Spring AI에서 RAG를 구현할 때는 ingestion, retrieval, generation을 분리해 실패 지점을 볼 수 있어야 한다. 기본 구현 흐름은 [09. Embedding VectorStore RAG ETL 설계](<../15. Spring AI/09. Embedding VectorStore RAG ETL 설계.md>)에서 이어진다.
- 전체 기능을 고객지원 서비스로 연결하는 예시는 [13. 고객지원 RAG Capstone](<../15. Spring AI/13. 고객지원 RAG Capstone.md>)을 함께 본다.
