...
- Spring AI 기반 RAG의 평가는 retriever 결과, context 조립, 최종 답변을 나눠 보아야 한다. 회귀 테스트 구조는 [10. Evaluation Testing Regression](<../15. Spring AI/10. Evaluation Testing Regression.md>)에서 이어진다.
- 운영 가능한 고객지원 RAG로 묶는 판단은 [13. 고객지원 RAG Capstone](<../15. Spring AI/13. 고객지원 RAG Capstone.md>)과 함께 확인한다.
