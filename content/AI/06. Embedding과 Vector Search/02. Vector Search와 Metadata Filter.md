...
- Spring AI RAG에서는 `VectorStore` 검색 조건이 서비스 권한 조건과 어긋나지 않아야 한다. metadata filter와 retrieval 흐름은 [09. Embedding VectorStore RAG ETL 설계](<../15. Spring AI/09. Embedding VectorStore RAG ETL 설계.md>)에서 이어진다.
- 검색 품질을 운영 지표로 확인하는 방법은 [10. Evaluation Testing Regression](<../15. Spring AI/10. Evaluation Testing Regression.md>)을 함께 본다.
