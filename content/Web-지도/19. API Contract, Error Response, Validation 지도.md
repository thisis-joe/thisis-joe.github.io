...
CONTROLLER["[Controller]<br/>DTO 수신·응답 방향 결정<br/>예: @PostMapping"]
...
HANDLER[["[ExceptionHandler]<br/>표준 에러 응답 변환<br/>예: @ControllerAdvice"]]
end

subgraph RESPONSE_FLOW["Client Handling"]
direction TB
RESPONSE["[APIResponse]<br/>Status, Header, Body<br/>예: 201 + JSON"]
CLIENTSTATE["[ClientState]<br/>클라이언트 처리 상태<br/>예: success, retry"]
end
