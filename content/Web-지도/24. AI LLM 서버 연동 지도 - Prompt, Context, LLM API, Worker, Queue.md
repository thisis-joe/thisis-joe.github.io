...
GUARD{"[Guardrail]<br/>개인정보·프롬프트 공격 방어<br/>예: PII mask, jailbreak"}
RESULT["[AIResponse]<br/>응답·근거·오류 상태<br/>예: answer, citation"]
end
...
linkStyle 0,13,14 stroke:#1565C0,stroke-width:2px;
linkStyle 1,2,3 stroke:#2E7D32,stroke-width:2px;
linkStyle 4,8,9 stroke:#6A1B9A,stroke-width:2px,stroke-dasharray:5 5;
linkStyle 5 stroke:#EF6C00,stroke-width:3px;
linkStyle 6,7,10 stroke:#6A1B9A,stroke-width:2px;
linkStyle 11,12,18,19 stroke:#C62828,stroke-width:2px;
linkStyle 15,16,17 stroke:#455A64,stroke-width:2px,stroke-dasharray:5 5;
```
---
...
- [Embedding과 Vector Search 압축 정리](<../AI/06. Embedding과 Vector Search/00. Embedding과 Vector Search 압축 정리.md>)
