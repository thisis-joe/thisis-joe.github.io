...
direction TB
TDUMP[["[ThreadDump]<br/>스레드 상태와 대기 위치<br/>예: BLOCKED, WAITING"]]
GCLOG[["[GCLog]<br/>GC pause와 heap 변화<br/>예: pause ms"]]
OSMETRIC[["[OSMetric]<br/>호스트 자원 지표<br/>예: CPU, fd, socket"]]
end
...
linkStyle 7,12,13,14,15 stroke:#455A64,stroke-width:2px,stroke-dasharray:5 5;
